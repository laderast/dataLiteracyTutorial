...
question("How many patients have High BMI (BMIstatus = `High`) and are Male (Gender = `Male`) from these first 10 rows?",
  answer("There are 3 patients.", message="Not quite. Go back and count."),
  answer("There are 4 patients.", correct=TRUE, message="Correct. There are 4 patients who have high BMI and are male."),
