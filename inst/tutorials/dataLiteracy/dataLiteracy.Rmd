...
The data below are the counts major categories of crimes by month/year from Portland Police.
...
This is another plot called a *stacked-area* plot. 
...
Are the total number of crimes continually increasing over time?
